...
export default function LoginPage() {
  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      {/* Mobile logo (hidden on lg where sidebar panel shows) */}
      ...
      <div className="space-y-1">
        ...
        <p className="text-sm text-muted-foreground">Sign in to your ProPilot account</p>
      </div>
      ...
      <p className="text-center text-sm text-muted-foreground">
        ...
        <Link href="/signup" className="font-medium text-primary hover:text-primary/80 transition-colors duration-150">
          Start free trial
        </Link>
      </p>
    </div>
